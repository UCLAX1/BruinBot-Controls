...
void Face::angry_frame2() {
   ...
   // ang_trans_1 = { 30, 0, 75 }
    concatenate{
        {changeColor(basic_eyes.pixelList, { 30, 0, 75 }), angry_mouth.pixelList} }
}
...
void Face::angry_frame4() {
    ...
    //new Pixel(3,6, eyebrowColor),
    //new Pixel(4,7, eyebrowColor),
    //new Pixel(11,7, eyebrowColor),
    //new Pixel(12,6, eyebrowColor),
    concatenate{
...
void Face::basic_smile(int h) {
    //mouth
    m_Matrix.mapLEDXY(6, h + 12, mouthColor); m_Matrix.mapLEDXY(7, h + 13, mouthColor); m_Matrix.mapLEDXY(8, h + 13, mouthColor); m_Matrix.mapLEDXY(9, h + 12, 
